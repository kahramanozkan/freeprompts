...
export default function PromptDetailClient({ params, initialPrompt, error, relatedPosts = [] }: PromptDetailClientProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="lg:order-2">
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-6">
              <div className="flex flex-col gap-4 mb-4">
                ...
                <div className="flex flex-row flex-wrap items-center gap-2">
                  ...
                  {/* Premium Share Popover */}
                  <div className="relative font-sans" ref={sharePopupRef}>
                    <button
                    ...
                    >
                      ...
                      {globalSiteLanguage === 'turkish' ? 'Paylaş' : 'Share'}
                    </button>
                    {/* Share Options Popup */}
                    <div
                      className={`absolute left-0 bottom-auto mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-50 transition-all duration-300 ease-out ${showShareOptions
                      ...
                      <div className="p-3">
                        <div className="flex flex-col gap-2">
                          <button
                            ...
                            className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-gray-100 transition-colors text-sm text-gray-700 w-full text-left"
                          >
                          ...
                          >
                            ...
                            <span>{globalSiteLanguage === 'turkish' ? 'Bağlantıyı Kopyala' : 'Copy Link'}</span>
                          </button>
                        </div>
                      </div>
                    </div>
            ...
            {/* Likes count */}
            <div className="flex items-center gap-4 mb-6 border-b border-gray-150 pb-6">
              <button
                onClick={handleLike}
      ...
      {relatedPosts && relatedPosts.length > 0 && (
        <div className="py-8 border-t border-gray-200" suppressHydrationWarning>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-semibold text-black mb-6">
              {globalSiteLanguage === 'turkish' ? 'İlgili Yapay Zeka Rehberleri' : 'Related AI Guides & Articles'}
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {relatedPosts.map((post) => {
                const postContent = post.translations[globalSiteLanguage as 'english' | 'turkish'] || post.translations.english;
                return (
                  <Link
                    key={post.slug}
                    href={`/blog/${post.slug}`}
                    className="group bg-gray-50 border border-gray-200 rounded-xl overflow-hidden hover:shadow-md transition-all duration-300 flex flex-col"
                  >
                    ...
                    <div className="p-4 flex-1 flex flex-col justify-between">
                      <div>
                        <span className="text-xs text-yellow-600 font-semibold tracking-wider uppercase mb-2 block">
                          {post.readTime}
                        </span>
                        <h3 className="font-semibold text-black text-base group-hover:text-yellow-600 transition-colors line-clamp-2 mb-2">
                          {postContent.title}
                        </h3>
                      ...
                      <div className="mt-4 text-xs text-gray-400">
                        {new Date(post.publishedAt).toLocaleDateString(globalSiteLanguage === 'turkish' ? 'tr-TR' : 'en-US', {
                          year: 'numeric',
                          month: 'short',
                          day: 'numeric'
                        })}
